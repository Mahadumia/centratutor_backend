...
/**
 * @route   GET /api/jupeb/subject
 * @desc    Get all JUPEB subjects
 * @access  Public
 */
...
/**
 * @route   POST /api/jupeb/subject/name/:name/years/:year/topics
 * @desc    Add topics to a JUPEB subject year
 * @access  Private
 */
...
/**
 * @route   POST /api/jupeb/subject/complete-setup
 * @desc    Create a new JUPEB subject with years and topics in one API call
 * @access  Private
 */
router.post('/complete-setup', async (req, res) => {
  try {
    ...
    console.error('Error in complete JUPEB subject setup:', error);
    res.status(500).json({ message: 'Server error', error: error.message });
  }
});

/**
 * @route   POST /api/jupeb/subject
 * @desc    Add a new JUPEB subject
...
/**
 * @route   POST /api/jupeb/subject/name/:name/years
 * @desc    Add years to a JUPEB subject
 * @access  Private
 */
...
/**
 * @route   GET /api/jupeb/subject/name/:name/years/:year/topics
 * @desc    Get topics for a specific JUPEB subject and year
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/name/:name/all-topics
 * @desc    Get all topics for a JUPEB subject across all years
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/id/:id/all-topics
 * @desc    Get all topics for a JUPEB subject by ID across all years
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/full-data
 * @desc    Get complete JUPEB data structure
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/:id
 * @desc    Get a JUPEB subject by ID
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/name/:name/years
 * @desc    Get years for a specific JUPEB subject
 * @access  Public
 */
...
/**
 * @route   GET /api/jupeb/subject/id/:id/years
 * @desc    Get years for a JUPEB subject by ID
 * @access  Public
 */
